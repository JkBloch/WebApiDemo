...
namespace JkBookStore.Api.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public async Task<IActionResult> SearchBooks(string title,string author)
        {
            var books = await _bookRepository.SearchBooksAsync(title,author);
            return Ok(books);
        }
